...
import { useSiteStore } from "../stores/siteState";
import {
  DocumentTextIcon,
  MoonIcon,
  PuzzlePieceIcon,
...
<template>
  <nav
    class="fixed w-full border-b border-gray-200 dark:border-gray-900 bg-white dark:bg-gray-900 z-10"
  >
      ...
      <div class="flex flex-wrap lg:flex-nowrap items-center w-full">
        <div class="flex flex-1 items-center">
          <svg
            ...
            height="35"
            viewBox="0 0 30 30"
            class="stroke-sky-500 dark:stroke-sky-500"
          >
            <path
              fill="url(#grad1)"
          ...
          <h1 class="font-bold text-2xl">Tornadotrax</h1>
          <span class="font-bold text-gray-400 text-xs">v2</span>
        </div>
        <ul
          class="flex items-center space-x-5 mt-3 sm:mt-0 text-sm font-semibold"
        >
          <router-link
            to="/"
            exact-active-class="bg-sky-50 text-sky-700 border border-sky-600 dark:bg-sky-900 dark:text-sky-50 dark:border-sky-600 rounded-full"
          >
            <li class="flex items-center px-3 py-1">
              <PuzzlePieceIcon class="h-4 w-4 mr-1" />
              Reports
            </li>
          </router-link>
          <router-link
          ...
          <li class="flex items-center">
            ...
            >
              <MoonIcon class="w-5 h-5 dark:stroke-sky-500" />
            </button>
          </li>
        </ul>
      </div>
